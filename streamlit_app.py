...
def show_fund_dataframe(rows):
    ...
    cols = ["Fon", "Fon Adı", "Son Fiyat", "Günlük", "Haftalık", "1 Ay", "3 Ay", "6 Ay", "Yılbaşından", "1 Yıl", "Kaynak"]
...
def main_app():
    ...
    st.caption("Kullanıcı bazlı portföy kayıtlıdır. Fon verileri 6 saatte bir yenilenir.")
