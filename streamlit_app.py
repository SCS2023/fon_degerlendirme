...
POPULAR_FUNDS = [
    ...
    "BPA", "BPE", "BPG", "BPH", "FBA", "FBB", "FBC", "FBD",
    "GBH", "GEH", "GHH", "GHK", "HEA", "HEH", "HHH", "HHT",
    "KAT", "KHT", "KPA", "KPT", "MGE", "MHE", "MHK", "MHT",
    "VBA", "VBE", "VBH", "VEH", "YBE", "YHB", "ZBE"
]
...
def show_history_chart(code):
    ...
    if "Tarih" not in hist_df.columns or "Fiyat" not in hist_df.columns:
        return
    ...
    fig = px.line(
        ...
        x="Tarih",
        y="Fiyat",
        title=f"{code} Son 45 Gün Fiyat Grafiği"
    )
    st.plotly_chart(fig, use_container_width=True)
...
def main_app():
    ...
    st.caption("Günlük/haftalık getiri TEFAS tarihsel fiyat serisinden hesaplanır. Veriler 6 saatte bir yenilenir.")
